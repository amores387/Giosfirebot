module.exports = {
    ...
    onStart: async function({ messageData, systemData, api, send, botID, addFont, origLog }) {
        const { senderID, threadID, messageReply, mentions } = messageData;
